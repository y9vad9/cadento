package cadento.tasks.domain.unittest

import cadento.tasks.domain.TaskStatus
import cadento.tasks.domain.TaskStatusId
import cadento.tasks.domain.TaskStatusName
import cadento.tasks.domain.isBuiltin
import cadento.tasks.domain.isCustom
import cadento.tasks.domain.isDone
import cadento.tasks.domain.isInProgress
import cadento.tasks.domain.isPaused
import cadento.tasks.domain.isPlanned
