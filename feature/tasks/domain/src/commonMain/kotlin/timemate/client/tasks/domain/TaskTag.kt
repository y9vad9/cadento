...
@JvmInline
value class TaskTag private constructor(
    val string: String,
) {
    companion object {
        ...
        fun create(value: String): CreationResult {
            return when {
                ...
                else -> CreationResult.Success(TaskTag(value))
            }
        }

        fun createOrThrow(value: String): TaskTag {
    ...
    sealed interface CreationResult {
        @JvmInline
        value class Success(val tagName: TaskTag) : CreationResult
